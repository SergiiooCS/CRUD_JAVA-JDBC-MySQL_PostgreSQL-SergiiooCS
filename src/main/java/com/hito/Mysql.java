...
public class Mysql
{
    public static <Int> void main(String[] args ) throws SQLException, IOException {
            ...
            switch (opcion) {
                ...
                case "3":
                    ...
                    try {
                        ...
                        System.out.println("No se ha podido actualizar los coches");
                        System.out.println(e.getMessage());
                    }
                    break;
                ...
                case "5":
                    ...
                    try {
                        Statement sentencia = con.createStatement();
                        String insert = "INSERT INTO t_propietario(id_propietario, nombre_propietario, telefono_propietario) VALUES (2, 'Isla', '666998877');";
                        sentencia.executeUpdate(insert);
                ...
                case "10":
                    try {
                        //COPIA DE SEGURIDAD.
                        //CREAMOS EL FICHERO DONDE GUARDAREMOS LOS DATOS.
                        PrintWriter pw= new PrintWriter(new File("copiaSeguridad_MySQL_COCHES.csv"));
                        //UTILIZAMOS UN OBJETO StringBuilder PARA ALMACENAR CADENAS DE TEXTO.
                        StringBuilder sb=new StringBuilder();
                ...
                case "11":
                    try{
                        //COPIA DE SEGURIDAD.
                        //CREAMOS EL FICHERO DONDE GUARDAREMOS LOS DATOS.
                        PrintWriter pw= new PrintWriter(new File("copiaSeguridad_MySQL_PROPIETARIO.csv"));
                        //UTILIZAMOS UN OBJETO StringBuilder PARA ALMACENAR CADENAS DE TEXTO.
                        StringBuilder sb=new StringBuilder();
                ...
                case "12":
                    try{
                        ...
                        String csvFilePath = "copiaSeguridad_MySQL_COCHES.csv";
                ...
                case "13":
                    try{
                        ...
                        String csvFilePath2 = "copiaSeguridad_MySQL_PROPIETARIO.csv";
                        ...
                        while ((lineText = lineReader2.readLine()) != null) {
                            ...
                            System.out.println(idcoche_propietario);
